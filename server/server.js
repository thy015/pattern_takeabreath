...
const MongoFacade = require('./src/facades/MongoFacade');
...
// mongo connect using MongoFacade
(async () => {
    try {
        await MongoFacade.connect( `mongodb+srv://thymai1510:${process.env.MONGO_DB}@cluster0.ibhghsi.mongodb.net/?appName=Cluster0`);
