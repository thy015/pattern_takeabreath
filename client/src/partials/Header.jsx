...
const Header = ({ children }) => {
  ...
  const items = [
    {
      label: (
        <a className="no-underline" href="/mybooking">
          My Reservation
        </a>
      ),
      key: "0",
  ...
  return (
    <div>
      <div className="fixed z-50 w-full">
            ...
            <div className="bg-[#114098] flex justify-between pt-12 pb-8">
              <ul className="flex items-end ">
                <Link to="/" className={hoverEffect}>
                  <li className="w-28 ">{t("booking")}</li>
                </Link>
                <Link to="/" className={hoverEffect}>
                  <li className="w-28">{t("activities")}</li>
                </Link>
                <Link to="/" className={hoverEffect}>
                  <li className="w-24">{t("coupons")}</li>
                </Link>
                <Link to="/" className={hoverEffect}>
                  <li className="w-28">{t("favs")}</li>
                </Link>
              </ul>
        ...
        <ProgressBar
          style={{ width: `${scrollProgress}%`, marginTop: "-5px" }}
        ></ProgressBar>
      </div>
